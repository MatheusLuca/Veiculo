...
public class Programa {
	...
	public static void main(String[] args) {
		...
		case 2:
			/*
			 * System.out.println("----CARRO----"); System.out.println("Qual a marca?");
			 * marca = input.next(); System.out.println("Modelo?"); modelo = input.next();
			 * System.out.println("Placa do veiculo"); placa = input.next();
			 * System.out.println("Qual o ano do veiculo?"); ano = input.nextInt();
			 * System.out.println("Tipo de combustivel"); tipoDeCombustivel = input.next();
			 * 
			 * Moto moto1 = new Moto(marca, modelo, placa, ano, tipoDeCombustivel, ano);
			 * double qtdCombustivelAtualMoto = moto1.geraCombustivel(); System.out.
			 * printf("\n------O valor do combustivel atual do carro é %.2f\n------" ,
			 * qtdCombustivelAtualMoto);
			 * 
			 * System.out.println("\nInsira um valor de distancia percorrida por KM:");
			 * double distanciaMotoPercorrida = input.nextDouble(); double consumoMotoPorKM
			 * = moto1.consumirCombustivel(distanciaMotoPercorrida,
			 * qtdCombustivelAtualMoto);
			 * System.out.printf("O consumo de combustivel por quilometro é de : %.2f\n" ,
			 * consumoMotoPorKM);
			 * 
			 * System.out.println(moto1.avisaAutonomia(qtdCombustivelAtualMoto,
			 * consumoMotoPorKM));
			 * 
			 * 
			 * 
			 * double velocidadeMoto = moto1.velocidadeMedia(distanciaMotoPercorrida,
			 * tempoValidoMoto);
			 * 
